    ...
    try {
      ...
      const prescription = await DonThuoc.findByPk(id, {
        include: [
          {
            model: LanKham,
            attributes: ['LanKhamId', 'MaLanKham', 'NgayKham', 'BacSiId'],
            include: [
              {
                model: HoSoKhamBenh,
                attributes: ['HoSoId', 'MaHoSo'],
      ...
      const pdfData = {
        ...
        MaHoSo: prescription.LanKham?.HoSoKhamBenh?.MaHoSo,
        NgayKham: prescription.LanKham?.NgayKham,
        CreatedAt: prescription.CreatedAt,
        GhiChu: prescription.GhiChu,
        BenhNhan: prescription.LanKham?.HoSoKhamBenh?.BenhNhan,
        BacSi: prescription.LanKham?.BacSi,
